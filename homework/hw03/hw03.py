...
def balanced(m):
    ...
    if is_planet(m):
        ...
        return left_w * left_l == right_w * right_l and balanced(end(left(m))) and balanced(end(right(m)))
...
def replace_leaf(t, find_value, replace_value):
    ...
    if is_leaf(t) and  label(t) == find_value:
        ...
        return tree(replace_value, new_branches)
    else:
        new_branches = [replace_leaf(b, find_value, replace_value) for b in branches(t)]
...
def preorder(t):
    ...
    if is_leaf(t):
        ...
        rest = [preorder(b) for b in branches(t)]
        # use sum to transform nested list to list, then concatenate it with root
        return [label(t)] + sum(rest, [])
